...
const orders = (() => {
    ...
    async function quickBuy(symbol, event) {
        ...
        try {
            ...
            if (cfg) {
                buyAmount = cfg.buyAmountUsdt || 55;
            }
        } catch (err) {
    ...
    async function fillManual(symbol, price) {
        ...
        try {
            ...
            if (cfg) {
                ...
                document.getElementById('m-total').value = cfg.buyAmountUsdt || 55;
    ...
    function _calcTarget(buyPrice, cfg) {
        ...
        if (buyPriceNum > 0) {
            if (cfg && cfg.profitAmountUsdt > 0) {
                ...
                const total = parseFloat(document.getElementById('m-total').value) || 55;
